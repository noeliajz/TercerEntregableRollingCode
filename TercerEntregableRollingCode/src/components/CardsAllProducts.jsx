...
const CardsAllProducts = ({array}) => {
  ...
  return (
    ...
    {
      array.map((articulo) =>
        <div key={articulo._id} className="card mx-3 text-center py-5 px-3 " style={{ width: '18rem', marginTop: '25px' }}>
          ...
          <div className="card-body ">
            ...
            <div>
            <button className='btn btn-outline-success py-2' onClick={() => handleClick(articulo._id)}>Agregar Carrito</button>
            </div>
          </div>
        </div>
      )
